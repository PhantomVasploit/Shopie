...
const productItem = JSON.parse(urlParams.get('product'))
...
productName.value = productItem.product_name
productCategory.value = productItem.category
productDescription.value = productItem.description
productPrice.value = productItem.price
productQuantity.value = productItem.quantity

let productUrlString = productItem.image
...
submitBtn.addEventListener('click', ()=>{
    ...
    if(productName.value && productDescription.value && productPrice.value && productUrlString && category && productQuantity.value){
        ...
        axios.put(`http://127.0.0.1:8080/api/shopie/v1/products/${productItem.id}`, 
        {
